...
with open(os.path.join(ROOT, 'chapter/__init__.py'), encoding='utf8') as fp:
...
if __name__ == "__main__":
    setuptools.setup(
        ...
        description='check the content',
        install_requires=REQUIRES,
        long_description=README,
        name='chapter',
        platforms='any',
        url='https://dev.package.checkitweg.de/chapter',
        version=VERSION,
        ...
        entry_points={
            'console_scripts': ['chapter = chapter.cli:main'],
        },
    )
